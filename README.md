...
3. Create a new *Web App* with Windows App Service Plan and give it the name of your tab, the same you used when asked for URL in the Yeoman generator. In your case https://teamsfluiddemo.azurewebsites.net.
...
11. Run the following command to set up the remote repository: `git remote add azure https://<username>@teamsfluiddemo.scm.azurewebsites.net:443/teamsfluiddemo.git`. You need to replace <username> with the username of the App Credentials you retrieved in _Deployment Credentials_. You can also copy the URL from *Options* in the Azure Web App.
...
13. Wait until the deployment is completed and navigate to https://teamsfluiddemo.azurewebsites.net/privacy.html to test that the web application is running
14. Done
