...
export interface IGitTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IGitTabRemoveProps {

}

/**
 * Implementation of git Tab remove page
 */
export class GitTabRemove  extends TeamsBaseComponent<IGitTabRemoveProps, IGitTabRemoveState> {
